public class FamilyHeirloom : Memento {
    public override string Name => "Family Heirloom";
    public override string Description => "+2 dodge bonus.";
    public override string Flavor => "Had she sold it, she wouldn't have had to work a single day.";
